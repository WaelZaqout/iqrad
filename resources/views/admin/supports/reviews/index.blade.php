...
<div class="container">
    ...
    <div class="header-section mb-4">
        <div class="row align-items-center mb-4">
            <div class="col-lg-6">
                <h2 class="mb-2 fw-bold text-primary">{{ __('admin.reviews_management') }}</h2>
                <p class="text-muted mb-0">{{ __('admin.manage_all_reviews_in_system') }}</p>
            </div>
            <div class="col-lg-6 text-lg-end">
                <div class="search-container">
                    <div class="input-group" style="width: 300px;">
                        <span class="input-group-text bg-light"><i class="fas fa-search"></i></span>
                        <input id="searchByName" type="text" placeholder="{{ __('admin.search_reviews') }}" class="form-control"
                            value="{{ $q ?? '' }}">
                    </div>
                </div>
            </div>
            ...
            <table class="table review-table">
                <thead>
                    <tr>
                        ...
                        <th style="min-width: 120px;">{{ __('admin.project_number') }}</th>
                        <th style="min-width: 150px;">{{ __('admin.investor_name') }}</th>
                        <th style="min-width: 120px;">{{ __('admin.rating') }}</th>
                        <th style="min-width: 100px;">{{ __('admin.comment') }}</th>
                        <th style="white-space: nowrap; min-width: 100px;">{{ __('admin.actions') }}</th>
                    </tr>
                </thead>
                <tbody id="categoriesTbody">
                    @include('admin.supports.reviews._rows', ['reviews' => $reviews])
                </tbody>
