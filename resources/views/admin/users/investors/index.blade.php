...
<div class="container">
                    ...
                    <div class="stat-card card h-100 border-0 shadow-sm">
                        <div class="card-body d-flex align-items-center p-3">
                            <div class="stat-icon bg-primary text-white rounded me-3 d-flex align-items-center justify-content-center"
                                ...
                                <i class="fas fa-investor-diagram"></i>
                            </div>
                            <div>
    ...
    <div class="table-container">
        <div class="table-responsive">
            <table class="table investor-table">
                <thead>
                    <tr>
                ...
                <tbody id="categoriesTbody">
                    @include('admin.users.investors._rows', ['investors' => $investors])
                </tbody>
        ...
        {{-- <div id="modalOverlay" class="modal-overlay">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 id="modalTitle">إضافة مستثمر جديد</h5>
